...
VL_INLINE_OPT void Vsinegen___024root___sequent__TOP__0(Vsinegen___024root* vlSelf) {
    ...
    if (vlSelf->rst) {
        ...
        __Vdly__top__DOT__address = (0xffU & ((IData)(vlSelf->top__DOT__address) 
                                              + (IData)(vlSelf->incr)));
    }
    vlSelf->dout1 = vlSelf->top__DOT__sineRom__DOT__rom_array
        [vlSelf->top__DOT__address];
    vlSelf->dout2 = vlSelf->top__DOT__sineRom__DOT__rom_array
